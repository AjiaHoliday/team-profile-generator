...
const generateCards = employeeCards => {
    const manager = employeeCards.manager.map(function(manager) {
        let managerCard = `
            <div class="card-deck">
                <div class="card">
        ...
        `
        return pageArray.push(managerCard);
    });
    ...
    const engineer = employeeCards.engineer.map(function(engineer) {
        let engineerCard = `
            ...
            `
           return pageArray.push(engineerCard);
    });
    ...
    const intern = employeeCards.intern.map(function(intern) {
        ...
        `
        return pageArray.push(internCard);
    });

    return employeeCards = pageArray.join('');
